...
<div class="container">
    <div class="card card-register mx-auto mt-5">
        <div class="card-header"><strong>Register New Sales Survey Question</strong></div>
      <div class="card-body">
...
<!--          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-6" >
                ...
                <select class="combobox form-control" id="inpGrp" name="G" value="1">
                                <option style="display:none"></option>
              ...
              <p>Are you sure that all of your inputs are correct?</p>
                <div class="col-sm-12 text-center" id="">
                    <div class="btn-group" role="group" aria-label="...">
                        <button type="submit" class="btn btn-primary" id="aRegQSales" data-dismiss="modal"><i class="fa fa-save" ></i> YES</button>
