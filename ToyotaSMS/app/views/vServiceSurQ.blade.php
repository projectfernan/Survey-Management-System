...
<link rel="stylesheet" href="plugins/css/customDes.css">
    ...
    <div class="card mb-3">
        <div class="card-header">
            <i class="fa fa-table"></i> Service Survey Questions</div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="ServiceSurQ" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>Number</th>
                      <th>Question</th>
              ...
              <p>Are you sure do you want to update this record?</p>
                <div class="col-sm-12 text-center" id="">
                    <div class="btn-group" role="group" aria-label="...">
                        <button type="submit" class="btn btn-primary" id="aEdtQService" data-dismiss="modal"><i class="fa fa-save" ></i> YES</button>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Are you sure do you want to delete this record?</p>
                <div class="col-sm-12 text-center" id="">
                    <div class="btn-group" role="group" aria-label="...">
                        <button type="submit" class="btn btn-primary" id="btnDelSerQ" data-dismiss="modal"><i class="fa fa-close" ></i> YES</button>
                        <button type="submit" class="btn btn-danger" id="bEdtNo" data-dismiss="modal"><i class="fa fa-undo" ></i> NO</button>
                    </div>
                </div>
              <div class="HideQid">
...
<script src="plugins/js/shwServiceQuestion.js"></script>
