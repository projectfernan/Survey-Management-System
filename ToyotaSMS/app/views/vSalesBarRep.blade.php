...
<div class="container" id="SalesBarParam">
    <div class="card card-register mx-auto mt-5">
        <div class="card-header"><strong>Generate Sales Survey Bar Graph Report</strong></div>
        <div class="card-body">
...
<!--                <button type="sumbmit" class="form-control btn-primary text-center" >Generate</button>-->
                <a class="btn btn-primary btn-block" href="#" target="_parent" id="aGenSalesBarRep">Generate</a>
            <!--</form>-->    
        ...
        <div class="panel-default">
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-3 text-center">
                        <button class="btn btn-secondary btn-block" href="#" id="bSalesBarBack">Back</button>
                    </div>
                    <div class="col-md-3 text-center">
